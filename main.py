...
jump_sound = pygame.mixer.Sound('music/Sound_22840.mp3')
die_sound = pygame.mixer.Sound('music/Sound_22840.mp3')
checkPoint_sound = pygame.mixer.Sound('music/Sound_22840.mp3')
...
def gameover_display_message(rbtn_image, gmo_image):
    ...
    rbtn_rect.center_x = width_screen / 2
    rbtn_rect.top = height_screen * 0.52

    gmo_rect = gmo_image.get_rect()
    gmo_rect.center_x = width_screen / 2
    gmo_rect.center_y = height_screen * 0.35
...
def extractDigits(num):
    ...
    class Dino():
        def __init__(self, sx=-1, sy=-1):
            self.imgs, self.rect = load_sprite_sheet('dinisavr1.png', 5, 1, sx, sy, -1)
            ...
            self.duck_position_width = self.rect.width
        ...
        def update(self):
            ...
            if not self.ducking:
                ...
                self.image = self.imgs[(self.index) % 2]
                                        ...
                                        def update(self, score):
                                            ...
                                            for s in score_digits:
                                                ...
                                                def introduction_screen():
                                                    ...
                                                    logo, l_rect = load_image('logo.png', 300,
                                                                                                      140, -1)
                                                    ...
                                                    while not starting_game:
                                                        ...
                                                        if pygame.display.get_surface() != None:
                                                            ...
                                                            screen_layout_display.blit(
                                                            t_ground[0], t_ground_rect)
